...
<%--&lt;%&ndash;<c:url value="/admin-guideline-listen-list.html" var="listenGuidelineListUrl">&ndash;%&gt;--%>
    <%--&lt;%&ndash;<c:param name="urlType" value="url_list"/>&ndash;%&gt;--%>
<%--&lt;%&ndash;</c:url>&ndash;%&gt;--%>
<%--&lt;%&ndash;<c:url value="/admin-user-list.html" var="userListUrl">&ndash;%&gt;--%>
    <%--&lt;%&ndash;<c:param name="urlType" value="url_list"/>&ndash;%&gt;--%>
<%--&lt;%&ndash;</c:url>&ndash;%&gt;--%>
    ...
    <%--<ul class="nav nav-list">--%>
        <%--<li class="">--%>
            <%--<a href="#" class="dropdown-toggle">--%>
                ...
                <%--&lt;%&ndash;<fmt:message key="label.guideline.listen" bundle="${lang}"/>&ndash;%&gt;--%>
        ...
        <%--<li class="">--%>
            ...
            <%--<ul class="submenu">--%>
                <%--<li class="">--%>
                    <%--&lt;%&ndash;<a href="<c:url value="/admin-exericse-upload.html"/>">&ndash;%&gt;--%>
                        <%--<i class="menu-icon fa fa-caret-right"></i>--%>
